...
exports.toDays = function(date) {
    return Math.floor(exports.toJulian(date)) - J2000;
};
...
exports.Moon = {
    ...
    getTimes: function(date, lat, lng) {
        ...
        result.moonrise = exports.toDays(date) + result.moonrise / 24;
        /*
        ...
        */
        ...
        result.moonset = exports.toDays(date) + result.moonset / 24;
        /*
